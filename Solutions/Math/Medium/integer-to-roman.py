...
class Solution:
    """
    Solution logic:
        We build the string by checking for each digit and adding the appropriate roman numeral characters
            to the result string.
        For each digit, we check the place, and whether it is 9, 8-5, 4, or less than 4 and convert those
            numbers into roman numerals appropriately. Each of those groups of numbers need to be handled
            specially as specified by the constraints and problem description.
    """
